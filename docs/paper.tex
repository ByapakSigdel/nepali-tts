...
model produces increasingly intelligible Nepali across multiple selectable voices. All code, configuration, and a clean-machine reproduction guide are released.
\end{abstract}
...
through step $\approx$27k (21 epochs) --- expected for VITS, whose aggregate loss saturates while perceptual
