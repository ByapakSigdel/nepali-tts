...
loanwords, dates, currency), a deeper (encoder/flow) warm-start, and --- as a separate research phase ---
expressive/emotional TTS, which requires emotion-labeled data that no public Nepali corpus currently provides.
